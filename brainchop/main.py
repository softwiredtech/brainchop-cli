...
import numpy as np
from brainchop.model import run_net
...
def main():
    ...
    # Check if we should export the model to WebGPU
    ...
    try:
        ...
        out_tensor = run_net(args.model, json_file, bin_file, t, export_webgpu)

        # model raw output
        out_data = out_tensor.numpy()[0]
        save(Nifti1Image(out_data, img.affine, img.header), args.output)
